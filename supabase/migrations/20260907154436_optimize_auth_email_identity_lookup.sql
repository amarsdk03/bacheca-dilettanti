-- Match the lookup performed by Supabase Auth so Postgres can use
-- auth.users_instance_id_email_idx instead of scanning auth.users.
...
begin
  ...
  where auth_user.instance_id = '00000000-0000-0000-0000-000000000000'::uuid
    and pg_catalog.lower(auth_user.email::text) = v_normalized_email
