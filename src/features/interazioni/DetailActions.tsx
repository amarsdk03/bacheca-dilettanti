...
export default async function DetailActions({href, target, presentation = "default"}: {href: string; target: InteractionTarget; presentation?: "default" | "profile" | "announcement"}) {
