...
import {summarizeProfileValues, summarizeStaffFigures, toPlayerCardData} from "./profile-card-model";
...
export default function ProfileCard({profile}: {profile: DirectoryProfile}) {
	...
	switch (profile.type) {
		...
		case "campi-impianti-sportivi": return <CampiImpiantiCard profile={{...card, type: "campi-impianti-sportivi", summary: summarizeProfileValues(profile.filterData.tipologie, "Spazi e servizi sportivi")}} />;
	}
}
