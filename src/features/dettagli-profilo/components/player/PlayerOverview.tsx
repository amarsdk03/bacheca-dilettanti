		...
		<div className="grid items-start gap-5 lg:grid-cols-[minmax(0,1.35fr)_minmax(0,1fr)]">
			<div className="flex min-w-0 flex-col gap-5">
				...
				{highlightsUrl && <Card>
					...
					<CardContent>
						<a href={highlightsUrl} target="_blank" rel="noopener noreferrer" className={buttonVariants({variant: "outline"})}>Guarda video highlights<ArrowUpRightIcon data-icon="inline-end" aria-hidden="true" /><span className="sr-only"> (si apre in una nuova scheda)</span></a>
					</CardContent>
				</Card>}
			</div>
