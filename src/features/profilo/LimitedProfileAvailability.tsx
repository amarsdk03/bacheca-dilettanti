...
} satisfies Record<LimitedProfileType, {title: string; description: string}>;
		...
		<Card>
			<CardHeader>
				<div className="flex flex-wrap items-center justify-between gap-2 mb-2">
					...
					<Badge
						className="bg-orange-100 text-yellow-700 text-sm flex items-center gap-1"
					>
